...
class PacketHandler:
    ...
    def _process_packet(self, packet_data: Dict[str, Any]):
        ...
        try:
            ...
            # Pre-processed packets (e.g. SNMPv3 regenerated by replay)
            # have already been decrypted and re-encrypted; forward directly
            # without running them through the SNMPv3 decrypt pipeline again.
            if packet_data.get('pre_processed'):
